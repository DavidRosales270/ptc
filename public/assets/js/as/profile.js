...
$("#banco").change(function(){
    var values = $("#banco").val();
    $('.load-creditos').load('/conamype/public/institution/' + values + '/getCreditos');
...
var values = $(this).val() ;
    $.ajax({
    dataType: "json",
    url: '/conamype/public/client/' + values + '/infoClient' ,
    success: function(data) {
        $('#name_giro').val(data.giro);
        $('#name_ciudad').val(data.ciudad);
    }
    });
